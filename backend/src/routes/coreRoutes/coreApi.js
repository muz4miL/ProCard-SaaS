...
const adminController = require(paths.adminController);
const settingController = require(paths.settingController);

const { singleStorageUpload } = require(paths.uploadMiddleware);
